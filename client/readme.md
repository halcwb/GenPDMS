...
This repository contaSGins build and test automation for the GenUnitApp client. It is based on the excellent [automatopia](https://github.com/jamesshore/automatopia.git) setup by James Shore. It includes:
...
See repository root [readme](https://github.com/halcwb/GenPDMS/blob/master/README.md)
